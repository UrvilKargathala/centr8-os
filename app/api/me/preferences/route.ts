    ...
    const [row] = await withOrgContext(userId, async (db) => {
      ...
      return db
        ...
        .set({
          ...
          defaultLandingPage: body.default_landing_page ?? undefined,
          timeFormat: body.time_format ?? undefined,
          dateFormat: body.date_format ?? undefined,
          weekStartsOn: body.week_starts_on ?? undefined,
          updatedAt: new Date(),
        })
