...
export function AskAiPageClient({ initialConversations }: { initialConversations?: Conversation[] }) {
  ...
  const skippedInitialLoad = useRef(!!initialConversations);
  useEffect(() => {
  ...
  return (
    <div className="flex h-[calc(100vh-8rem)] flex-col gap-4 lg:flex-row">
      <div className="glass hidden w-[280px] shrink-0 flex-col rounded-md lg:flex">
      ...
      <div className="glass flex flex-1 flex-col rounded-md">
        {active ? (
          <div className="border-b border-neutral-300 p-3">
            {titleEditing ? (
              <Input
