...
export default function SprintPlansPage() {
  const { selectedOrgId, can, loading: orgLoading } = useOrg();
  const [projects, setProjects] = useState<Project[]>([]);
  const [projectFilter, setProjectFilter] = useState("");
  const [plans, setPlans] = useState<SprintPlanProposal[]>([]);
  ...
  useEffect(loadPlans, [selectedOrgId, projectFilter]); // eslint-disable-line react-hooks/exhaustive-deps
