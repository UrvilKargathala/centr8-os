...
export type Person = { id: string; fullName: string; jobTitle: string | null };

export type TasksInitialData = { rows: Row[]; counts: Counts; projects: Project[]; people: Person[] };
...
export function TasksPageClient({ initial }: { initial?: TasksInitialData }) {
  return (
    <Suspense fallback={<PageSkeleton variant="table" />}>
      <TasksInner initial={initial} />
    </Suspense>
  );
}

function TasksInner({ initial }: { initial?: TasksInitialData }) {
