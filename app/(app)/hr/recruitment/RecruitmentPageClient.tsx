...
export function RecruitmentPageClient({ initialJobs }: { initialJobs?: JobPosting[] }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "Job Postings" && <JobPostingsTab orgId={selectedOrgId} refreshKey={refreshKey} initial={initialJobs} />}
...
function JobPostingsTab({ orgId, refreshKey, initial }: { orgId: string; refreshKey: number; initial?: JobPosting[] }) {
  const [jobs, setJobs] = useState<JobPosting[]>(initial ?? []);
