...
export type MyReviewRow = { cycle: Cycle; review: Review };

export function ReviewsPageClient({ initialMyReviews }: { initialMyReviews?: MyReviewRow[] }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "My Reviews" && <MyReviewsTab orgId={selectedOrgId} initial={initialMyReviews} />}
...
function MyReviewsTab({ orgId, initial }: { orgId: string; initial?: MyReviewRow[] }) {
  const [rows, setRows] = useState<MyReviewRow[]>(initial ?? []);
