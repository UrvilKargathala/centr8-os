...
export type Contact = { id: string; fullName: string; accountId: string | null };
...
export type DealsInitialData = { deals: Deal[]; accounts: Account[]; contacts: Contact[]; employees: Employee[]; stats: PipelineStats };
...
export function DealsPageClient({ initial }: { initial?: DealsInitialData }) {
  ...
  const [stats, setStats] = useState<PipelineStats | null>(initial?.stats ?? null);
