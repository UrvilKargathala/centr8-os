...
export type ContactsInitialData = { contacts: Contact[]; accounts: Account[]; employees: Employee[] };
...
export function ContactsPageClient({ initial }: { initial?: ContactsInitialData }) {
  ...
  }, [selectedOrgId, accountId, ownerId, decisionMakerOnly, search]);
