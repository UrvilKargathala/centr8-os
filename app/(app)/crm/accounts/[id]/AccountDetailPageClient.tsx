...
export type Contact = { id: string; fullName: string; email: string | null; jobTitle: string | null; accountId?: string | null };
export type Activity = { id: string; type: string; relatedType: string; subject: string | null; description: string | null; activityDate: string };
export type Deal = { id: string; name: string; stage: string; value: number | null; currency: string; expectedCloseDate: string | null };
export type Employee = { id: string; fullName: string };

export type AccountDetailInitialData = { account: Account; contacts: Contact[]; activities: Activity[]; deals: Deal[] };
...
export default function AccountDetailPageClient({ initial }: { initial?: AccountDetailInitialData }) {
  ...
  const [editForm, setEditForm] = useState<Account | null>(initial?.account ?? null);
