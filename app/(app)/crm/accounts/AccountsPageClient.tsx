...
export type Contact = { id: string; accountId: string | null };
export type Employee = { id: string; fullName: string };

export type AccountsInitialData = { accounts: Account[]; contacts: Contact[]; employees: Employee[] };

export function AccountsPageClient({ initial }: { initial?: AccountsInitialData }) {
  ...
  }, [selectedOrgId, type, status, industry, ownerId, search]);
