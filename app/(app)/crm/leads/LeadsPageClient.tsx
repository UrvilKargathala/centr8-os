...
export function LeadsPageClient({
  ...
  const { selectedOrgId, can, loading: orgLoading, permissionsLoading } = useOrg();
  ...
  const skippedInitialLoad = useRef(!!initialLeads);
  useEffect(() => {
  ...
  }, [selectedOrgId, status, source, ownerId, scoreMin, scoreMax, search]);
  ...
  if (orgLoading || loading || permissionsLoading) return <PageSkeleton variant="table" />;
