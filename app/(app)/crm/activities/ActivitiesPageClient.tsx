...
export type ActivitiesInitialData = { activities: Activity[]; employees: Employee[] };
...
export function ActivitiesPageClient({ initial }: { initial?: ActivitiesInitialData }) {
  ...
  }, [selectedOrgId, relatedType, activityType, performedBy, dateFrom, dateTo]);
